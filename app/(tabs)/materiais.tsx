...
export default function Materiais() {
  ...
  useEffect(() => {
    const fetchMateriais = async () => {
      const response = await fetch(`${SERVER}api/material`);
      const data = await response.json();
      setMateriais(data);
    };

    const fetchTipo = async () => {
      const response = await fetch(`${SERVER}api/tipo`);
      const data = await response.json();
      setTipo(data);
    };

    const fetchConteudo = async () => {
      const response = await fetch(`${SERVER}api/conteudo`);
      const data = await response.json();
      setConteudo(data);
    };
  ...
  const removerMaterial = async () => {
    ...
    await fetch(`${SERVER}api/material/${materialParaExcluir}`, {
      method: "DELETE",
    });
